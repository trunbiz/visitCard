@extends('front.Base')
@section('title','Đăng nhập | thẻ cao cấp VisitCard')
@section('main')
            ...
            <div>
                ...
                <div class="row box-gray relative">
                    <form method="POST" id="frmregister">
                        ...
                        <div class="col-md-9">
                            ...
                            <p>Nếu bạn đã có tài khoản tại VisitCard, vui lòng đăng nhập tại đây.<br>
                ...
                <div class="row box-gray relative">
                    <div class="col-md-9">
                        ...
                        <p>Nếu bạn mới đến VisitCard, vui lòng chọn “ĐĂNG KÝ NGAY”</p>
                    </div>
