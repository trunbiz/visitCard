@extends('admin.Base')
@section('title','Visit Card | Quản trị website')
@section('main')
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#">
			...
			<div class="row">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-red panel-widget ">
						<div class="row no-padding"><i class="fa fa-rss-square" aria-hidden="true"></i>
							<div class="large">{{$countblog}}</div>
